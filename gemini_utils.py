...
def recheck_single_column(column_array, model_name, answer_key_path):
    ...
    try:
        ...
        prompt = [
            ...
            "  \"3\": \"X - No visible mark\",  // No mark visible\n"
            "  \"4\": \"X - Multiple marks detected\",  // Multiple marks found\n"
            "  \"5\": \"X - Mark too faint to determine\",  // Faint mark\n"
            "  \"6\": \"X - Partial mark detected\",  // Partial mark\n"
